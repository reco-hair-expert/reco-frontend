...
describe('Button Component', () => {
  ...
  it('applies correct size class', () => {
    ...
    expect(screen.getByText('Large Button').parentElement).toHaveClass('button--l');
  });

  it('applies correct variant class', () => {
    render(<Button variant="secondary">Secondary Button</Button>);
    expect(screen.getByText('Secondary Button').parentElement).toHaveClass('button--secondary');
  });

  it('applies correct state class', () => {
    render(<Button state="hover">Hover Button</Button>);
    expect(screen.getByText('Hover Button').parentElement).toHaveClass('button--primary--hover');
  });
  ...
  it('applies disabled class when disabled', () => {
    render(<Button disabled>Disabled Button</Button>);
    expect(screen.getByText('Disabled Button').parentElement).toHaveClass('button--disabled');
  });
}); 