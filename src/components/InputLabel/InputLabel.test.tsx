...
describe('InputLabel Component', () => {
  ...
  it('applies correct class', () => {
    const { container } = render(<InputLabel htmlFor="test-input">Test Label</InputLabel>);
    expect(container.querySelector('label')).toHaveClass('inputLabel');
  });

  it('renders star icon when required is true', () => {
    render(<InputLabel htmlFor="test-input" required>Test Label</InputLabel>);
  ...
  it('does not render star icon when required is false', () => {
    render(<InputLabel htmlFor="test-input" required={false}>Test Label</InputLabel>);
